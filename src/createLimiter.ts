import {LimiterAudioNodeOptions, ILimiterAudioWorkletNode}  from "./types/CreateLimiterTypes";
...
class LimiterAudioWorkletNode extends AudioWorkletNode implements ILimiterAudioWorkletNode{
    get attack(){ 
...
function validateOptions(options?: LimiterAudioNodeOptions): Error | void {
    if(!options) return;
...
function normalizeOptions(options?: LimiterAudioNodeOptions): LimiterAudioNodeOptions{
