...
export function validateLimiterNodeOptions(options?: LimiterAudioNodeOptions): Error | void {
    if(!options) return;
...
export function normalizeLimiterNodeOptions(options?: LimiterAudioNodeOptions): LimiterAudioNodeOptions{
